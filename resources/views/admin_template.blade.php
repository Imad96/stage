            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li class="hoveredLink">
                        <a class="active-menu " href={{route('accueil_admin')}}><i class="fa fa-dashboard"></i> Tableau de bord</a>
                    </li>
                    <li class="hoveredLink">
                        <a href={{route('ajouter_compte')}}><i class="fa fa-plus "></i> Ajouter un compte</a>
                    </li>
                    <li class="hoveredLink">
